...
function Get-InstalledSoftware {
    ...
    if (-not $UninstallKeys) {
        ...
        foreach ($UninstallKey in $UninstallKeys) {
            ...
            if($chrInstalled -eq $Null){ return $False }
            return $True
        }
    }
}
...
function Test-JavaInstalled {
    ...
    if (-not $UninstallKeys) {
        ...
        foreach ($UninstallKey in $UninstallKeys) {
            ...
            $javaInstalled = Get-ChildItem @gciParams | Where $WhereBlock | Select-Object -Property $selectProperties
            if($javaInstalled -eq $Null){ return $False }
            return $True    
        }
    }
}
...
function Test-ChromeInstalled {
    ...
    if($chromeInstalled -eq $Null){ return $False }
    return $True
}
